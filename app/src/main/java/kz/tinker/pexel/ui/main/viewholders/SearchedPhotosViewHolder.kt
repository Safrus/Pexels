...
class SearchedPhotosViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bindData(photo: Photo?, photoClickListener: SearchedPhotoAdapter.PhotoClickListener) {
        photo?.let {
